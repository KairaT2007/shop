...
const ProfileTestimonials = () => {
    return (
        <section className='py-8 sm:py-16 lg:py-24'>
            <Carousel
                className='mx-auto flex max-w-7xl gap-12 max-sm:flex-col sm:items-center sm:gap-16 lg:gap-24'
                opts={{
                    align: 'start',
                    slidesToScroll: 1
                }}
                    ...
                    <CarouselContent className='sm:-ml-6'>
                        {testimonials.map((testimonial, index) => (
                            <CarouselItem key={index} className='sm:pl-6 lg:basis-1/2'>
                                <Card className='border-2 hover:border-primary h-full transition-colors duration-300 bg-background/50 backdrop-blur-sm'>
